...
test('Complete Airth Password Reset Flow with Gmail', async () => {
    // Use persistent context to access existing Chrome profile with Gmail logged in
    // You may need to adjust this path to your Chrome user data directory
    ...
    try {
        ...
        console.log('Step 8: Opening the most recent email...');
        const firstEmail = gmailPage.locator('tr.zA, tr.yO, table[role="grid"] tr').first();
